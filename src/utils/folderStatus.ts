...
> = {
  draft: {
    label: 'Draft',
    shortLabel: 'Draft',
    dark: 'border-border/70 border-dashed bg-muted/20 text-muted-foreground',
    light: 'border-border border-dashed bg-muted/30 text-muted-foreground',
    dashed: true,
  },
  in_review: {
    label: 'In review',
    shortLabel: 'In Review',
    dark: 'border-amber-500/35 bg-amber-500/10 text-amber-400/95',
    light: 'border-amber-600/30 bg-amber-50 text-amber-800',
  },
  accepted: {
    label: 'Accepted',
    shortLabel: 'Accepted',
    dark: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-400/95',
  ...
  rejected: {
    label: 'Rejected',
    shortLabel: 'Rejected',
    dark: 'border-red-500/35 bg-red-500/10 text-red-400/95',
    light: 'border-red-600/30 bg-red-50 text-red-700',
  },
  changes_requested: {
    label: 'Changes requested',
    shortLabel: 'Changes',
    dark: 'border-orange-500/35 bg-orange-500/10 text-orange-400/95',
    light: 'border-orange-600/30 bg-orange-50 text-orange-800',
  },
};
