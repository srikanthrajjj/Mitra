...
export function LandingFooterReveal({ onGetStarted }: LandingFooterRevealProps) {
  ...
  return (
    <footer
      id="contact"
      className="landing-footer-reveal relative z-[2] overflow-hidden border-t border-white/[0.06] bg-[var(--landing-bg)] px-6 py-14 md:py-16"
    >
      <div
        className="pointer-events-none absolute inset-x-0 bottom-[-12rem] h-[26rem] bg-[radial-gradient(circle_at_center,rgba(128,182,161,0.32)_0%,rgba(128,182,161,0.14)_28%,transparent_68%)] blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-x-[22%] bottom-0 h-px bg-[rgba(128,182,161,0.35)] blur-sm"
        aria-hidden
      />
