              ...
              <div className="grid grid-cols-4 sm:grid-cols-8 gap-2">
                {palette[shadeTheme].map((shade) => (
                  <div key={shade.token} className="rounded-lg overflow-hidden border border-border bg-card">
                    <div className="h-12 w-full" style={{ backgroundColor: shade.hex }} />
                    <div className="p-2 space-y-0.5">
                      <p className="text-[10px] font-mono font-semibold text-foreground leading-tight">{shade.token}</p>
                      <p className="text-[9px] font-mono text-brand-green/70 leading-tight">{shade.hex}</p>
...
const shadePalettes = [
  {
    ...
    dark: [
      { token: 'primary-50',   hex: '#142414', tailwind: 'bg-primary-50' },
      { token: 'primary-100',  hex: '#1A3218', tailwind: 'bg-primary-100' },
      { token: 'primary-200',  hex: '#24481F', tailwind: 'bg-primary-200' },
      { token: 'primary-300',  hex: '#316726', tailwind: 'bg-primary-300' },
      { token: 'primary-400',  hex: '#3F8F2B', tailwind: 'bg-primary-400' },
      { token: 'primary-500',  hex: '#4FCF36', tailwind: 'bg-primary-500' },
      { token: 'primary-600',  hex: '#72E95A', tailwind: 'bg-primary-600' },
      { token: 'primary-700',  hex: '#98F584', tailwind: 'bg-primary-700' },
    ],
    light: [
      { token: 'primary-50',   hex: '#F2FDEA', tailwind: 'bg-primary-50' },
      { token: 'primary-100',  hex: '#DCF8D2', tailwind: 'bg-primary-100' },
      { token: 'primary-200',  hex: '#B8F0A8', tailwind: 'bg-primary-200' },
      { token: 'primary-300',  hex: '#82E96C', tailwind: 'bg-primary-300' },
      { token: 'primary-400',  hex: '#4ED62A', tailwind: 'bg-primary-400' },
      { token: 'primary-500',  hex: '#19AF00', tailwind: 'bg-primary-500' },
      { token: 'primary-600',  hex: '#158F00', tailwind: 'bg-primary-600' },
      { token: 'primary-700',  hex: '#106F00', tailwind: 'bg-primary-700' },
    ],
  },
  {
    name: 'secondary',
    ...
    dark: [
      { token: 'secondary-50',   hex: '#202428', tailwind: 'bg-secondary-50' },
      { token: 'secondary-100',  hex: '#2A2E33', tailwind: 'bg-secondary-100' },
      { token: 'secondary-200',  hex: '#363B42', tailwind: 'bg-secondary-200' },
      { token: 'secondary-300',  hex: '#484E57', tailwind: 'bg-secondary-300' },
      { token: 'secondary-400',  hex: '#636A75', tailwind: 'bg-secondary-400' },
      { token: 'secondary-500',  hex: '#828991', tailwind: 'bg-secondary-500' },
      { token: 'secondary-600',  hex: '#A3AAB3', tailwind: 'bg-secondary-600' },
      { token: 'secondary-700',  hex: '#CDD2D7', tailwind: 'bg-secondary-700' },
    ],
    light: [
      { token: 'secondary-50',   hex: '#F8F9FA', tailwind: 'bg-secondary-50' },
      { token: 'secondary-100',  hex: '#F0F2F4', tailwind: 'bg-secondary-100' },
      { token: 'secondary-200',  hex: '#E4E7EA', tailwind: 'bg-secondary-200' },
      { token: 'secondary-300',  hex: '#CED2D7', tailwind: 'bg-secondary-300' },
      { token: 'secondary-400',  hex: '#969BA2', tailwind: 'bg-secondary-400' },
      { token: 'secondary-500',  hex: '#6B7280', tailwind: 'bg-secondary-500' },
      { token: 'secondary-600',  hex: '#464C57', tailwind: 'bg-secondary-600' },
      { token: 'secondary-700',  hex: '#2C3138', tailwind: 'bg-secondary-700' },
    ],
  },
  {
    name: 'dark',
    ...
    dark: [
      { token: 'dark-50',   hex: '#383838', tailwind: 'bg-dark-50' },
      { token: 'dark-100',  hex: '#333333', tailwind: 'bg-dark-100' },
      { token: 'dark-200',  hex: '#2B2B2B', tailwind: 'bg-dark-200' },
      { token: 'dark-300',  hex: '#242424', tailwind: 'bg-dark-300' },
      { token: 'dark-400',  hex: '#1F1F1F', tailwind: 'bg-dark-400' },
      { token: 'dark-500',  hex: '#171717', tailwind: 'bg-dark-500' },
      { token: 'dark-600',  hex: '#121212', tailwind: 'bg-dark-600' },
      { token: 'dark-700',  hex: '#0A0A0A', tailwind: 'bg-dark-700' },
    ],
    light: [
      { token: 'dark-50',   hex: '#F5F5F5', tailwind: 'bg-dark-50' },
      { token: 'dark-100',  hex: '#EDEDED', tailwind: 'bg-dark-100' },
      { token: 'dark-200',  hex: '#E0E0E0', tailwind: 'bg-dark-200' },
      { token: 'dark-300',  hex: '#D1D1D1', tailwind: 'bg-dark-300' },
      { token: 'dark-400',  hex: '#BDBDBD', tailwind: 'bg-dark-400' },
      { token: 'dark-500',  hex: '#8F8F8F', tailwind: 'bg-dark-500' },
      { token: 'dark-600',  hex: '#616161', tailwind: 'bg-dark-600' },
      { token: 'dark-700',  hex: '#333333', tailwind: 'bg-dark-700' },
    ],
  },
];
