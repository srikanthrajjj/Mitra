...
const shadePalettes = [
  {
    ...
    dark: [
      { token: 'primary-50',   hsl: 'hsl(140 20% 18%)', tailwind: 'bg-primary-50' },
      { token: 'primary-100',  hsl: 'hsl(140 25% 22%)', tailwind: 'bg-primary-100' },
      { token: 'primary-200',  hsl: 'hsl(140 35% 28%)', tailwind: 'bg-primary-200' },
      { token: 'primary-300',  hsl: 'hsl(140 45% 35%)', tailwind: 'bg-primary-300' },
      { token: 'primary-400',  hsl: 'hsl(140 55% 45%)', tailwind: 'bg-primary-400' },
      { token: 'primary-500',  hsl: 'hsl(140 65% 52%)', tailwind: 'bg-primary-500' },
      { token: 'primary-600',  hsl: 'hsl(140 75% 60%)', tailwind: 'bg-primary-600' },
      { token: 'primary-700',  hsl: 'hsl(140 85% 68%)', tailwind: 'bg-primary-700' },
    ],
    light: [
  ...
  },
  {
    ...
    dark: [
      { token: 'secondary-50',   hsl: 'hsl(210 14% 14%)', tailwind: 'bg-secondary-50' },
      { token: 'secondary-100',  hsl: 'hsl(210 14% 18%)', tailwind: 'bg-secondary-100' },
      { token: 'secondary-200',  hsl: 'hsl(210 13% 24%)', tailwind: 'bg-secondary-200' },
      { token: 'secondary-300',  hsl: 'hsl(210 12% 32%)', tailwind: 'bg-secondary-300' },
      { token: 'secondary-400',  hsl: 'hsl(210 11% 42%)', tailwind: 'bg-secondary-400' },
      { token: 'secondary-500',  hsl: 'hsl(210 10% 54%)', tailwind: 'bg-secondary-500' },
      { token: 'secondary-600',  hsl: 'hsl(210 12% 66%)', tailwind: 'bg-secondary-600' },
      { token: 'secondary-700',  hsl: 'hsl(210 16% 82%)', tailwind: 'bg-secondary-700' },
    ],
    light: [
