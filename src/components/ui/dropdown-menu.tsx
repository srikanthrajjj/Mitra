...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-xl bg-popover p-1.5 text-popover-foreground shadow-[0_16px_40px_-12px_rgba(15,23,42,0.24),0_4px_12px_-4px_rgba(15,23,42,0.08)] dark:shadow-[0_16px_40px_-8px_rgba(0,0,0,0.6)]',
      className,
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        // Borderless: elevation comes from the shadow alone.
        'z-50 min-w-[8rem] overflow-hidden rounded-xl bg-popover p-1.5 text-popover-foreground shadow-[0_16px_40px_-12px_rgba(15,23,42,0.24),0_4px_12px_-4px_rgba(15,23,42,0.08)] dark:shadow-[0_16px_40px_-8px_rgba(0,0,0,0.6)]',
        className,
      )}
      {...props}
