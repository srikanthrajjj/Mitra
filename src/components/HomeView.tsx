  ...
  return (
    <div className="flex flex-1 flex-col h-full overflow-hidden bg-transparent">
      <div className="flex-1 overflow-y-auto px-4 pt-8 pb-8 md:px-8 lg:px-12">
        {announcement && (
          <div className="sticky top-3 z-20 mx-auto mb-8 w-full max-w-3xl">
            <AnnouncementBar
              ...
              <div className="relative flex flex-col p-3">
                ...
                <div className="-mx-3 -mb-3 mt-3 flex items-center justify-between rounded-b-[14px] bg-muted/50 px-4 py-2">
                  ...
                  <div className="flex items-center gap-1">
                    <Button variant="ghost" size="icon" className="h-8 w-8" title="Voice input" aria-label="Voice input">
