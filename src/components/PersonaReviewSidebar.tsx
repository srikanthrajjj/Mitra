...
interface PersonaReviewSidebarProps {
...
export function PersonaReviewSidebar({
  reviews,
  selectedReviewId = null,
  onContactArchitect,
  onSelectReview,
  personaLabel,
  emptyHint = 'No reviews assigned to you right now.',
}: PersonaReviewSidebarProps) {
    ...
    <div className="stakeholder-sidebar flex h-full flex-col px-3 py-4">
      <div className="mb-4 px-1">
        ...
        {pending.length > 0 ? (
          ...
          <p className="mt-2 text-[12px] leading-relaxed text-muted-foreground">{emptyHint}</p>
        )}
      </div>
